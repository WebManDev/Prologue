...
function AthleteBrowseCard({
  ...
  return (
    <Card className="min-w-[350px] max-w-[400px] rounded-2xl border border-gray-200 shadow-md hover:shadow-lg transition-all duration-200 bg-white overflow-hidden">
      {/* Cover + Avatar */}
          ...
          <div className="grid grid-cols-12 gap-10">
            ...
            <div className="col-span-9">
              <TabsContent value="browse" className="space-y-8">
                ...
                {viewMode === "grid" ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-12 justify-center" style={{gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))'}}>
                    {filteredAthletes.map((athlete) => (
                      <AthleteCard key={athlete.id} athlete={athlete} />
                    ))}
                  </div>
