...
import { auth, createUserWithEmailAndPassword, GoogleAuthProvider, smartSignIn } from "@/lib/firebase"
...
export default function AthleteSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to athlete onboarding
        ...
        <div className="max-w-md w-full">
          <div className="bg-white rounded-2xl p-8 shadow-2xl border border-white/10">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-2 tracking-tight">Create Athlete Account</h1>
              <p className="text-base text-gray-600 leading-relaxed">Share your expertise and coach others</p>
            </div>
            {/* Google Sign Up */}
            <div className="mb-6">
              <Button
                type="button"
                variant="outline"
                className="w-full h-12 rounded-xl border-2 border-gray-300 hover:border-orange-400 bg-white flex items-center justify-center space-x-3 font-semibold text-base shadow-none"
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-12 rounded-xl border-2 border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 transition-all duration-200 pr-12"
                    required
                  />
                  <button
                    type="button"
              ...
              <Button
                type="submit"
                className={`w-full h-12 rounded-xl font-semibold tracking-wide shadow-none transition-all duration-200 text-white text-base ${isFormValid ? 'bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600' : 'bg-orange-100 text-orange-400 cursor-not-allowed'}`}
              ...
              <div className="flex justify-center items-center space-x-2 mt-4">
                ...
                <div className="w-8 h-2 rounded-full bg-orange-100" />
              </div>
            </form>
          </div>
        </div>
