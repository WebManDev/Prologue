        ...
        <div className="max-w-md w-full">
          <div className="bg-white rounded-2xl p-8 shadow-2xl border border-white/10">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-2 tracking-tight">Athlete Login</h1>
              <p className="text-base text-gray-600 leading-relaxed">Share your expertise</p>
            </div>
            {/* Google Sign In */}
            <div className="mb-6">
              <Button
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {errorMessage && (
                <div className="text-red-600 text-sm text-center py-2">{errorMessage}</div>
              )}
              <Button
                type="submit"
              ...
              >
                {isSubmitting ? 'Signing in...' : (<><span>SIGN IN</span><ArrowRight className="ml-2 h-4 w-4" /></>)}
              </Button>
              <Button
                type="button"
                variant="ghost"
