...
export interface AthleteLoginPageProps {
  isSignUp: boolean;
  loading: boolean;
  error?: string;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-900 via-slate-800 to-red-800 relative overflow-hidden">
      ...
      <header className="px-6 lg:px-8 h-16 flex items-center justify-between backdrop-blur-md border-b border-gray-700/50 relative z-10">
        ...
        <button type="button" onClick={onBack} className="flex items-center space-x-2 text-gray-300 hover:text-white group">
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-2xl">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-3">
                {isSignUp ? "Create Your Coach Account" : "Welcome Back, Coach!"}
              </h1>
              <p className="text-lg text-gray-600">
                {isSignUp ? "Sign up to start coaching" : "Sign in to continue coaching"}
              </p>
            </div>
            ...
            <form onSubmit={onSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full h-12 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white rounded-xl font-bold"
                disabled={loading}
              >
                {loading ? (
                  <>
