...
import { BookOpen, Video, FileText, Trash2, GripVertical, Plus, Upload, Camera, Badge } from "lucide-react";
...
export function ExactCourseCreationForm({ onSubmit, onSuccess }: { onSubmit: (data: CourseData) => Promise<void> | void, onSuccess?: () => void }) {
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="bg-white rounded border border-input focus-within:ring-2 focus-within:ring-blue-500/20">
            <LexicalRichTextEditor value={courseData.description} onChange={handleDescriptionChange} />
          </div>
        </div>
        {/* Lessons Section */}
        ...
        <div className="flex justify-end space-x-3 pt-4">
          <Button
            ...
            disabled={isLoading || courseData.lessons.length === 0 || !courseData.title}
          >
            {isLoading ? (
              <>
