        ...
        <div className="pt-8 px-8 pb-10">
          <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-8">
            ...
            <div className="flex-shrink-0 flex justify-center lg:block mb-6 lg:mb-0 relative">
              <div className="w-32 h-32 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full border-4 border-white flex items-center justify-center shadow relative">
                ...
                <div className="flex flex-wrap items-center space-x-2 min-h-[40px]">
                  ...
                  {isEditing ? (
                    <div className="flex space-x-2 ml-4 items-center">
                      <Button onClick={onSave} disabled={isLoading} size="sm" className="bg-blue-600 hover:bg-blue-700">
                        {isLoading ? <Loader2 className="h-4 w-4 animate-spin" /> : <Save className="h-4 w-4" />}
                        <span className="ml-2">Save Changes</span>
                      </Button>
                      <Button variant="outline" onClick={() => { setEditingField(null); setFormData(profileData); onEditToggle(); }} disabled={isLoading} size="sm" className="bg-transparent">
                        Cancel
                      </Button>
                    </div>
                  ) : (
