              ...
              {activeTab === "feedback" && (
                <CardContent className="flex-1 p-6">
                  <div className="space-y-3 sm:space-y-6">
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 sm:p-8 text-center w-full max-w-full mx-auto -mt-2 sm:mt-0 min-h-[300px] sm:min-h-0 flex flex-col justify-center">
